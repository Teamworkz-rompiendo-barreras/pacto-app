...
const RitualConclusions: React.FC<RitualConclusionsProps> = ({ onBack, onFinish }) => {
  return (
    <div className="bg-[#F0E8D1] text-[#121316] font-display min-h-screen flex flex-col antialiased animate-fade-in">
        {/* Top Navigation */}
        <header className="w-full px-6 py-4 flex justify-center border-b border-[#E6DCC3] bg-[#F0E8D1]/90 backdrop-blur-sm sticky top-0 z-50">
            <div className="w-full max-w-[960px] flex items-center justify-between">
                <div className="flex items-center gap-3 text-primary">
                    <div className="size-8 bg-primary text-white rounded-lg flex items-center justify-center shadow-sm">
                ...
                <div className="flex items-center gap-4">
                    <span className="hidden sm:block text-sm font-medium text-[#6a6d81]">Equipo de Diseño</span>
                    <button className="flex size-10 cursor-pointer items-center justify-center rounded-full bg-white hover:bg-[#FCF8ED] text-[#121316] transition-colors border border-[#E6DCC3]">
