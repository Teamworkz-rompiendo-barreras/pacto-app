        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          {activeTab === 'general' && (
              <div className="space-y-8 animate-fade-in">
                  <div className="pb-6 border-b border-primary/10">
                    <h2 className="text-4xl font-black tracking-tight text-text-n900">Información General</h2>
                    <p className="text-lg text-gray-600 mt-2">Configura los detalles básicos de tu espacio de trabajo.</p>
                  </div>
              ...
              <div className="space-y-8 animate-fade-in">
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-primary/10">
                    <div className="space-y-2">
                        <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-none text-text-n900">Equipos</h2>
                        <p className="text-lg text-gray-600 max-w-xl font-medium">Crea y gestiona grupos para organizar tus acuerdos y miembros.</p>
                    </div>
                    <button 
          ...
          {activeTab === 'team' && (
              <div className="space-y-8 animate-fade-in">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-primary/10">
                    <div className="space-y-2">
                        <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-none text-text-n900">Directorio de Usuarios</h2>
                        <p className="text-lg text-gray-600 max-w-xl font-medium">Administra los miembros de tu organización.</p>
                    </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        {paginatedUsers.map((user) => (
                            <tr key={user.id} className="hover:bg-bg-s1/30 transition-colors group">
                                ...
                                <td className="px-6 py-4">
                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold border uppercase tracking-tight ${
                                ...
                                {user.status === 'Pendiente' ? (
                                    <button 
                                        ...
                                        className={`font-black text-sm uppercase tracking-wider underline-offset-4 transition-all ${
                                            resentStatus[user.email] === 'sent' 
          ...
          {activeTab === 'roles' && (
              <div className="space-y-8 animate-fade-in">
                  <div className="pb-6 border-b border-primary/10">
                    <h2 className="text-4xl font-black tracking-tight text-text-n900">Roles y Permisos</h2>
                    <p className="text-lg text-gray-600 mt-2">Define qué pueden hacer los diferentes niveles de usuario.</p>
                  </div>
          ...
          {activeTab === 'settings' && (
              <div className="space-y-8 animate-fade-in">
                <div className="flex flex-col gap-2 pb-6 border-b border-primary/10">
                    <h3 className="text-4xl font-black tracking-tight text-text-n900">Accesibilidad Global</h3>
                    <p className="text-lg text-gray-600 font-medium">Define estándares de visualización predeterminados para toda la organización.</p>
                </div>
