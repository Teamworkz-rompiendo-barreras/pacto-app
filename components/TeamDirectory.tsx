    ...
    return (
        <PageContainer>
            <PageHeader
                ...
                subtitle="Encuentra a tus compañeros y descubre sus mejores formas de colaborar."
                badge={
                    <>
            ...
            <div className="flex flex-col md:flex-row gap-8 w-full animate-fade-in pb-12">
                ...
                <aside className="w-full md:w-72 flex-shrink-0 hidden md:block h-fit sticky top-4">
                    {/* Desktop Back Button Removed (Moved to PageHeader) */}
                ...
                <div className="flex-1 flex flex-col gap-8 min-w-0">
                    ...
                    <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-border flex flex-row gap-4 relative z-10 mb-8 items-center">
                        <div className="relative flex-1">
                            ...
                            <input
                                type="text"
                                className="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-lg outline-none focus:ring-2 focus:ring-primary text-text-n900 placeholder:text-gray-500 font-medium border-transparent transition-all"
